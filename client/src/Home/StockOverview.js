...
const [tableData, setTableData] = useState([
  ...
  return (
    ...
    <div className="flex xl:container xl:mx-auto overflow-x-auto relative bg-red-500 my-7 h-fit">
        <div className="flex-inital w-3/4 bg-blue-500">
        <div className="flex flex-col">
            <div>
                <div className="flex flex-row">
                <h1 className='text-lg uppercase text-bold'>Stock Overview</h1>
            ...
            {/* Table and Graph */}
            <div className="flex">
                <StockTable data={tableData} rowsNumber={7}></StockTable>
